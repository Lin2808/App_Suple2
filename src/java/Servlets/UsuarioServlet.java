...
public class UsuarioServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        switch(this.opcion){
            case "datosUsuarios":
                    response_server = uscon.listarUsuarios();
                break;
            case "habilitarUsuario":
                String id_usuario = request.getParameter("id_usuario");
                    response_server = uscon.habilitarUsuario(id_usuario);
                break;
            case "insertarusuario":
                ...
                this.response_server = "{\"message\":\""+uscon.insertarUsuario
        (nombres, apellidos, nombre_tienda, estado, tipo_usuario, nombre_user, 
                contrasenia)+"\"}";
